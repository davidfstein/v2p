...
from .predict_module import cython_predict_proba
...
class LabelPowerset(ProblemTransformationBase):
    ...
    def predict_proba(self, X):
        ...
        result = cython_predict_proba(X, lp_prediction, [np.array(r) for r in self.reverse_combinations_], self._label_count)
        return result
